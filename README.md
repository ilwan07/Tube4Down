...
- Batch download
- Rename your files before downloading them
- 100% free, no ads, no data collection* (*YouTube instances running in the app might collect some data, but the app in itself doesn't)
...
Note: This software is delivered with no warranty, and may sometimes not work, or break after YouTube updates their service. If that happens, prefer using the source python code with up to date packages. This app is not 100% reliable.
...
- choisissez parmi de nombreuses extensions de fichiers
...
Note : Ce logiciel est livré sans aucune garantie, et peut parfois ne pas fonctionner, ou ne plus du tout marcher après une mise à jour par YouTube de leurs services. Si cela arrive, putilisez plutôt le code source Python avec les bibliothèques à jour. Cette application n'est pas 100% fiable.
